    ...
    <>
      <div className="bg-black/80  sm:bg-center    w-full  h-screen   mx-auto font-raleway" style={{ backgroundImage: `url(${back})` }}>
        ...
        <div className="flex flex-col items-center w-full p-4 justify-center">
          ...
          <div className="container mx-auto bg-black/30 p-4 flex flex-col w-4/5 sm:w-2/5    text-white  rounded-lg backdrop-blur-sm  absolute top-20  ">
            ...
            <form onSubmit={handleSubmit} className={`w-full my-1 text-left`}>
              ...
              <input
                ...
                id="email"
                name="email"
                className=" bg-black/20 p-2 h-10  w-full  border-white my-4 border-b-4 outline-none "
                onChange={onChange}
                value={cred.email}
              />
              <br />
